...
RSpec.describe SalonsController, type: :controller do
  ...
  # Salon. As you add validations to Salon, be sure to
  ...
  # SalonsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested salon as @salon" do
      salon = Salon.create! valid_attributes
      get :show, {:id => salon.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested salon as @salon" do
      salon = Salon.create! valid_attributes
      get :edit, {:id => salon.to_param}, valid_session
      expect(assigns(:salon)).to eq(salon)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Salon" do
        expect {
          post :create, {:salon => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved salon as @salon" do
        post :create, {:salon => invalid_attributes}, valid_session
        expect(assigns(:salon)).to be_a_new(Salon)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested salon" do
        salon = Salon.create! valid_attributes
        put :update, {:id => salon.to_param, :salon => new_attributes}, valid_session
        salon.reload
      ...
      it "assigns the requested salon as @salon" do
        salon = Salon.create! valid_attributes
        put :update, {:id => salon.to_param, :salon => valid_attributes}, valid_session
        expect(assigns(:salon)).to eq(salon)
      end
    ...
    context "with invalid params" do
      it "assigns the salon as @salon" do
        salon = Salon.create! valid_attributes
        put :update, {:id => salon.to_param, :salon => invalid_attributes}, valid_session
        expect(assigns(:salon)).to eq(salon)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested salon" do
      salon = Salon.create! valid_attributes
      expect {
        delete :destroy, {:id => salon.to_param}, valid_session
      }.to change(Salon, :count).by(-1)
    end
